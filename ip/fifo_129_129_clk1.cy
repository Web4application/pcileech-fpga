{
  ...
  "ip_inst": {
    "xci_name": "fifo_129_129_clk1",
    "component_reference": "xilinx.com:ip:fifo_generator:13.2",
    "ip_revision": "9",
    "gen_directory": "../../../../pcileech_screamer_m2.gen/sources_1/ip/fifo_129_129_clk1",
    "parameters": {
      "component_parameters": {
        "Component_Name": [ { "value": "fifo_129_129_clk1", "resolve_type": "user", "usage": "all" } ],
        ...
        "Input_Data_Width": [ { "value": "129", "value_src": "user", "resolve_type": "user", "format": "long", "usage": "all" } ],
        "Input_Depth": [ { "value": "16", "value_src": "user", "resolve_type": "user", "usage": "all" } ],
        "Output_Data_Width": [ { "value": "129", "value_src": "user", "resolve_type": "user", "enabled": false, "usage": "all" } ],
        "Output_Depth": [ { "value": "16", "value_src": "user", "resolve_type": "user", "format": "long", "enabled": false, "usage": "all" } ],
        "Enable_ECC": [ { "value": "false", "resolve_type": "user", "format": "bool", "enabled": false, "usage": "all" } ],
        "Use_Embedded_Registers": [ { "value": "false", "resolve_type": "user", "format": "bool", "enabled": false, "usage": "all" } ],
        ...
        "Data_Count_Width": [ { "value": "4", "value_src": "user", "resolve_type": "user", "format": "long", "enabled": false, "usage": "all" } ],
        "Write_Data_Count": [ { "value": "false", "resolve_type": "user", "format": "bool", "enabled": false, "usage": "all" } ],
        "Write_Data_Count_Width": [ { "value": "4", "value_src": "user", "resolve_type": "user", "format": "long", "enabled": false, "usage": "all" } ],
        "Read_Data_Count": [ { "value": "false", "resolve_type": "user", "format": "bool", "enabled": false, "usage": "all" } ],
        "Read_Data_Count_Width": [ { "value": "4", "value_src": "user", "resolve_type": "user", "format": "long", "enabled": false, "usage": "all" } ],
        ...
        "Full_Threshold_Assert_Value": [ { "value": "14", "value_src": "user", "resolve_type": "user", "format": "long", "enabled": false, "usage": "all" } ],
        "Full_Threshold_Negate_Value": [ { "value": "13", "value_src": "user", "resolve_type": "user", "format": "long", "enabled": false, "usage": "all" } ],
      ...
      "model_parameters": {
        ...
        "C_DIN_WIDTH": [ { "value": "129", "resolve_type": "generated", "format": "long", "usage": "all" } ],
        "C_DOUT_RST_VAL": [ { "value": "0", "resolve_type": "generated", "usage": "all" } ],
        "C_DOUT_WIDTH": [ { "value": "129", "resolve_type": "generated", "format": "long", "usage": "all" } ],
        ...
        "C_MEMORY_TYPE": [ { "value": "2", "resolve_type": "generated", "format": "long", "usage": "all" } ],
        ...
        "C_PRIM_FIFO_TYPE": [ { "value": "512x72", "resolve_type": "generated", "usage": "all" } ],
    ...
    "boundary": {
      "ports": {
        ...
        "din": [ { "direction": "in", "size_left": "128", "size_right": "0", "driver_value": "0" } ],
        "wr_en": [ { "direction": "in", "driver_value": "0" } ],
        "rd_en": [ { "direction": "in", "driver_value": "0" } ],
        "dout": [ { "direction": "out", "size_left": "128", "size_right": "0", "driver_value": "0" } ],
